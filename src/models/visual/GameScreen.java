...
public class GameScreen {
	...
	// Setters
	public void setObjectOnLocation(BaseModel object, int x, int y) {
		this.screenMatrix[y][x] = object.getSymbol();
	}

	public void setOrderOnLocation(Order order, int x, int y) {
		this.screenMatrix[y][x] = order.getSymbol();
	}
}
